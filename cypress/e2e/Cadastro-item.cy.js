describe('Fluxo de Cadastro de item', () => {
  it('Deve Cadastrar um item', () => {
    ...
    cy.wait(3000);
    cy.get(
      '#modalGalpao > .modal-dialog > .modal-content > .modal-header > .btn-close',
    ).click();

    //
    cy.get(
      ':nth-child(1) > :nth-child(2) > :nth-child(1) > :nth-child(1) > :nth-child(2) > .form-input > input',
    ).type('1234999');
    cy.get(':nth-child(1) > :nth-child(3) > .form-input > input').type(
      'aaaaaamw',
    );
    ...
    cy.get(
      '.col-md-8 > .box_line > .row > :nth-child(2) > :nth-child(1) > input',
    ).type('1');
    ...
    cy.get(
      ':nth-child(3) > .box_line > .row > :nth-child(1) > :nth-child(1) > input',
    ).type('1');
    cy.get(
      ':nth-child(3) > .box_line > .row > :nth-child(2) > :nth-child(1) > input',
    ).type('1');
    cy.get('.box_line > .row > :nth-child(3) > :nth-child(1) > input').type(
      '1',
    );
    cy.get(
      ':nth-child(3) > .box_line > .row > :nth-child(1) > :nth-child(2) > input',
    ).type('1');
